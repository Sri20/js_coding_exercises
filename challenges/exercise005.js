...
const count1sand0s = str => {
  ...
  let countarr = strarr.reduce((numarr, num) => {
...
const getWordFrequencies = str => {
  if (str === undefined) throw new Error("str is required");
  let strarr = ((str.replace(/[^0-9a-zA-Z. ]/g, '')).toLowerCase()).split(' ')
  let countarr = strarr.reduce((newarr, word) => {
